...
## Corpus Check
- 204 files · ~501,296 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2092 nodes · 5102 edges · 103 communities (80 shown, 14 thin omitted)
...
Cohesion: 0.06
Nodes (28): LastfmView, ListenbrainzView, SettingsView, DownloadedView(), LastfmView(), ListenbrainzView(), MiniPlayer(), OnboardingWizard() (+20 more)
...
### Community 6 - "Vec"
Cohesion: 0.05
Nodes (23): BiquadFilter, CircularDelayLine, AideoFilterNode, AllPassFilter, AudioNode, CompressorNode, CrossfeedNode, DSPState (+15 more)
...
Cohesion: 0.16
Nodes (24): createLibrarySlice(), fetchTrackMetadataAndLyrics(), chainQueueOperation(), createPlaybackSlice(), performDspInvoke(), queueOperationPromise, notifyQobuzAuthFailure(), createTidalSlice() (+16 more)

### Community 14 - "baseName"
Cohesion: 0.11
Nodes (22): CastSelector(), CoverArtModal(), SearchResult, FullscreenView(), KaraokeActiveLine, KaraokeActiveLineProps, LiquidBackground(), LocalQRCode() (+14 more)
...
Cohesion: 0.12
Nodes (10): AideoApp(), AideoLabView, AlbumsView, App(), DownloadedView, FullscreenView, AideoPrompt(), mockIsFullscreen (+2 more)
...
Cohesion: 0.13
Nodes (22): AlbumCard, AlbumCardProps, AlbumGroup, AlbumsView(), AlbumsViewProps, coverArtCache, getSavedLovedAlbums(), pendingArtRequests (+14 more)

### Community 19 - "types.ts"
Cohesion: 0.08
Nodes (23): CacheSizeInfo, TrackRowProps, SearchCoverResult, AudioTagBatchUpdate, AudioTagData, AudioTagUpdate, BatchDownloadItem, BatchDownloadProgress (+15 more)

### Community 20 - "logger.ts"
Cohesion: 0.15
Nodes (15): DebugLogsModal(), DebugLogsModalProps, ErrorBoundaryProps, ErrorBoundaryState, addBreadcrumb(), Breadcrumb, breadcrumbs, CONSOLE_STYLES (+7 more)

### Community 21 - "play_file"
Cohesion: 0.18
Nodes (27): AtomicU32, AtomicU64, Child, Producer, abort_background_downloads(), ActiveStreamSession, background_decode(), CachedTrack (+19 more)
...
Cohesion: 0.12
Nodes (22): baseName(), CloudCacheButtonProps, CloudTrack, CloudTrackRow, cloudTrackToVirtualTrack(), coverArtCache, isLosslessTrack(), isStreamTrack() (+14 more)

### Community 25 - "BiquadFilter"
Cohesion: 0.13
Nodes (8): Complex, Fft, BiquadFilter, ConvolutionFilter, Arc, Self, Vec, VecDeque
...
Cohesion: 0.09
Nodes (17): ActiveStream, DecoderInfo, get_network_telemetry(), is_stream_prebuffer_ready(), NetworkTelemetry, PlaybackStatus, resolve_hardware_upsample_and_dither(), resolve_stream_volume() (+9 more)
...
### Community 36 - "getSupabaseClient"
Cohesion: 0.36
Nodes (8): BrowserCallbackLanding(), OauthChildCallback(), createAuthSlice(), getSupabaseClient(), getSupabaseCredentials(), resetSupabaseClient(), syncFromCloud(), syncToCloud()
...
### Community 39 - ".new"
Cohesion: 0.18
Nodes (16): ChildStdin, SeekFrom, analyzer_loop(), detect_audio_extension(), detect_format_from_path(), enforce_cache_size_limit(), get_cache_paths(), measure_latency() (+8 more)
...
### Community 42 - "String"
Cohesion: 0.20
Nodes (18): Instant, clear_youtube_url_cache(), get_cached_youtube_url(), insert_cached_youtube_url(), invalidate_youtube_url_if(), pre_resolve_youtube_url(), resolve_youtube_url(), Path (+10 more)
...
### Community 58 - "ConvolutionNode"
Cohesion: 0.32
Nodes (4): ConvolutionNode, decoded_frames(), extract_f32_channel_data(), AudioBufferRef

### Community 59 - "GrowingFileReader"
Cohesion: 0.29
Nodes (5): File, MediaSource, Read, Seek, GrowingFileReader
...
### Community 85 - "safeGetStorage"
Cohesion: 0.17
Nodes (17): DesktopLyricBar(), createMetadataSlice(), AideoPageDesign, LEGACY_AIDEO_PAGE_DESIGNS, LyricLine, LyricsDisplayMode, SidebarNavItemConfig, SidebarNavItemId (+9 more)
...
- **Why does `Player` connect `play_file` to `player/mod.rs`, `Vec`, `.new`, `AppState`, `String`, `dsp_tests.rs`?**
